        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <InputRoot>
                <InputControl defaultValue="Gustavo" />
              </InputRoot>
              <div className="flex flex-col gap-3 lg:block">
                ...
                <InputRoot>
                  <InputControl id="lastName" defaultValue="Jezini" />
                </InputRoot>
              </div>
            </div>
            <div />
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <InputRoot>
              ...
              <InputControl
                id="email"
                type="email"
                defaultValue="Gustavojezini@gmail.com"
              />
            </InputRoot>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Select placeholder="Select a Timezone...">
              <SelectItem
                value="pacific"
                text="Pacific Standard Timme (UTC-08:00)"
              />
              <SelectItem
                value="america"
